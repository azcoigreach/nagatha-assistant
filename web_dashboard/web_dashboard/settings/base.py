"""
Base Django settings for web_dashboard project.
"""
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'dev-key-change-in-production-immediately')
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # For base project, allow open access
    ],
