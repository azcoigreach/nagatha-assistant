#!/usr/bin/env python3
"""
Simple test script for the unified server implementation.

This script tests the core functionality without requiring the Agent
to have a process_message method.
"""
...
from nagatha_assistant.server.core.session_manager import UnifiedSessionManager
...
async def test_session_manager():
    ...
    try:
        ...
        # Test session info
        session = await session_manager.get_session(session_id1)
        print(f"Session interfaces: {session.interfaces}")
        ...
        # Test memory sharing
        await session_manager.share_memory_across_sessions(session_id1)
        print("✓ Memory sharing works")
...
async def main():
    """Run all tests."""
    print("🧪 Testing Nagatha Unified Server Components")
    print("=" * 50)
    ...
    try:
        ...
        print("\n" + "=" * 50)
        print("✅ All component tests passed! The unified server foundation is working correctly.")
        print("\nNext steps:")
